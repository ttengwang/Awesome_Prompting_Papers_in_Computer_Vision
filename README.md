...
![prompt-position](https://img.shields.io/badge/text--prompt-blue?style=for-the-badge)
![prompt-position](https://img.shields.io/badge/vision--prompt-blue?style=for-the-badge)
...
1. `CVPR'22` DenseCLIP: Language-Guided Dense Prediction with Context-Aware Prompting	[[paper]](https://arxiv.org/pdf/2112.01518.pdf)[[code]](https://github.com/raoyongming/denseclip)  ![task](https://img.shields.io/badge/task-semantic--segmentation-green?style=for-the-badge)
![task](https://img.shields.io/badge/task-instance--segmentation-green?style=for-the-badge)
![task](https://img.shields.io/badge/task-object--detection-green?style=for-the-badge)
2. `Arxiv 21/09` **(CoOP)** Learning to Prompt for Vision-Language Models 	[[paper]](https://arxiv.org/abs/2109.01134) [[code]](https://github.com/KaiyangZhou/CoOp) ![task](https://img.shields.io/badge/task-image--classification-green?style=for-the-badge)
    - `CVPR'22` Prompt Distribution Learning [[paper]](https://arxiv.org/pdf/2205.03340.pdf) ![task](https://img.shields.io/badge/task-image--classification-green?style=for-the-badge) ![task](https://img.shields.io/badge/task-image--classification-green?style=for-the-badge)
    - `CVPR'22` **(CoCoOp)** Conditional Prompt Learning for Vision-Language Models [[paper]](https://arxiv.org/pdf/2203.05557.pdf) [[code]](https://github.com/KaiyangZhou/CoOp) ![task](https://img.shields.io/badge/task-image--classification-green?style=for-the-badge)
    - `Arxiv 22/06` **(DualCoOp)** DualCoOp: Fast Adaptation to Multi-Label Recognition with Limited Annotations [[paper]](https://arxiv.org/abs/2206.09541) ![task](https://img.shields.io/badge/task-image--classification-green?style=for-the-badge)
    - `Arxiv 22/05` Prompt-aligned Gradient for Prompt Tuning [[paper]](https://arxiv.org/abs/2205.14865) [[code]](https://github.com/BeierZhu/Prompt-align) ![task](https://img.shields.io/badge/task-image--classification-green?style=for-the-badge)

3. `Arxiv 21/10` CLIP-Adapter: Better Vision-Language Models with Feature Adapters [[paper]](https://arxiv.org/abs/2110.04544) [[code]](https://github.com/gaopengcuhk/clip-adapter)
...
6. `Arxiv 22/04` **(UPL)** Unsupervised Prompt Learning for Vision-Language Models [[paper]](https://arxiv.org/pdf/2204.03649.pdf) [[code]](https://github.com/tonyhuang2022/UPL)

7. `Arxiv 22/06` **(NOAH)** Neural Prompt Search [[paper]](https://arxiv.org/abs/2206.04673) [[code]](https://github.com/Davidzhangyuanhan/NOAH)
